...
def diceIMG():
    ...
    print(''.join(map(str, listy2[7])), "Pieces Reached Goal:")
    print(''.join(map(str, listy2[8])), "┌─────────┐     ┌─────────┐")
    print(''.join(map(str, listy2[9])), "│", B3Goal, " ",B4Goal , "│     │", B3Goal, " ",B4Goal , "│")
    print(''.join(map(str, listy2[10])), "│", B3Goal, " ",B4Goal , "│     │", B3Goal, " ",B4Goal , "│")
    print(''.join(map(str, listy2[11])), "└─────────┘     └─────────┘")
...
def diceRoll():
    global diceRoll1
    global diceRoll2
    diceRoll1 = random.randint(1,3)
    diceRoll2 = random.randint(1,3)
    diceIMG()
...
##
##
##    #if you land on another players piece...
##        if (colour == "Blue"):
##        elif (colour == "Green"):
##            if (X == BX1) and (Y == BY1):
##                BX1 = 5
                ...
                if (BY1 == 2) and (BY2 == 2) and (BY3 == 4) and (BY4 == 4):
                    if (diceRoll1 == diceRoll2):
                        ...
                        while (pieceVar == 0):
                            ...
                            if (piece == "1") or (piece == "2") or (piece == "3") or (piece == "4"):
                                pieceVar = 1
                                pieceMove()
                else:
                    pieceVar = 0
                ...
                if (GY1 == 19) and (GY2 == 19) and (GY3 == 21) and (GY4 == 21):
                    ...
                    while (pieceVar == 0):
                        ...
                        if (piece == "1") or (piece == "2") or (piece == "3") or (piece == "4"):
                            ...
                            pieceMove()
            time.sleep(1)
            if (B1Goal == "B1") and (B2Goal == "B2") and (B3Goal == "B3") and (B4Goal == "B4"):
                winner1 = "1"
            elif (G1Goal == "G1") and (G2Goal == "G2") and (G3Goal == "G3") and (G4Goal == "G4"):
                winner1 = "2"
